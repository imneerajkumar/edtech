...
function Profile(props) {
  ...
  const [iprogress, setIProgress] = useState(0);
	const [details, setDetails] = useState({
		name: "Neeraj Kumar",
		email: "nijjukr@gmail.com",
		userImage: "assets/images/author/author-11.jpg",
		contact: "9650788185",
		address: "Burari",
		city: "New Delhi",
		state: "Delhi",
      ...
      <div className="section page-banner">
        ...
        <div className="container">
          <div className="page-banner-content">
              ...
              <h2 className="title">About <span>{details.name}.</span></h2>
          </div>
        </div>
        ...
        <div className="container">						
          <div className="register-login-wrapper">
            <div className="row align-items-center">								
              <div className="col">
                <div className="">
                  <h3 className="title mt-5">About <span>Me</span></h3>
