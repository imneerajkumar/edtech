      ...
      <div className="section page-banner">
        ...
        <div className="container">            
          <div className="page-banner-content">
            ...
            <h2 className="title">Live <span>Classes</span></h2>
          </div>
        </div>
                ...
                {lectures?.map((lecture) => (
                  <div className="col-lg-4 col-md-6" key={lecture._id}>
                    <div className="single-courses">
                      ...
                      <div className="courses-content" style={{paddingTop: "10px"}}> 
                        <div className="courses-author">
                          ...
                          <div className="courses-price-review" style={{padding: "7px 15px"}}>
                            {lecture.subjectName}
													</div>
                        </div>
                        ...
                        <div className="courses-meta" style={{paddingTop: "0px"}}>
                          <span className="time">
                            {" "}
                        ...
                        <Link to={`/meet/${lecture.meetingId}`}>
                          <div className="join-now" style={{marginTop: "10px"}}>Join Now</div>
                        </Link>
                      </div>
                    </div>
                  </div>
