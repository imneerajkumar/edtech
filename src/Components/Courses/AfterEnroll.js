      ...
      <div className="section login-header">
          ...
          <div className="login-header-wrapper navbar navbar-expand">
              ...
              <div className="login-header-logo logo-2">
                  ...
                  <a href="/"><img src="assets/images/text-logo.png" alt="Logo" /></a>
              </div>
              {/* <!-- Header Logo End --> */}
              ...
              <div className="login-header-action action-2 ml-auto">
                  <div className="dropdown">
                      ...
                      <div className="dropdown-menu dropdown-notification">
                          ...
                          <a className="all-notification" href="/after-enroll">See all notifications <i className="icofont-simple-right"></i></a>
                      </div>
                  </div>
                  ...
                  <div className="dropdown">
                      ...
                      <ul className="dropdown-menu">
                          <li><a className="" href="/after-enroll"><i className="icofont-user"></i> Profile</a></li>
                          <li><a className="" href="/after-enroll"><i className="icofont-inbox"></i> Inbox</a></li>
                          <li><a className="" href="/after-enroll"><i className="icofont-logout"></i> Sign Out</a></li>
                      </ul>
                  </div>
              </div>
              {/* <!-- Header Action End --> */}
                  ...
                  <div className="courses-enroll-content">
                      ...
                      <div className="courses-enroll-tab">
                          ...
                          <div className="enroll-share">
                              <a href="/after-enroll"><i className="icofont-share-alt"></i> Share</a>
                          </div>
                      </div>
                                      ...
                                      <div className="row">
                                          ...
                                          <div className="col-lg-8">
                                              <div className="enroll-tab-content">
                                                  ...
                                                  <p className="text">“Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has industry's standard dummy text ever since the 1500s when andom unknown printer took a galley scrambled it to make a type specimen book.”</p>
                      ...
                      <div className="accordion" id="videoPlaylist">
                          ...
                          <div className="accordion-item">
                              ...
                              <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link active" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <div className="accordion-item">
                              ...
                              <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <div className="accordion-item">
                              ...
                              <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <div className="accordion-item">
                              ...
                              <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <!-- Accordion Items Start  --> */}
                          <div className="accordion-item">
                              <button className="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix">
                                  <p>Lesson-06: How to Write a Personal Statement - The Complete Medicine MasterclassName</p>
                                  <span className="total-duration">01 hour 48 minutes</span>
                              </button>

                              <div id="collapseSix" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <!-- Accordion Items Start  --> */}
                          <div className="accordion-item">
                              <button className="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSaven">
                                  <p>Lesson-07: Autobiographical Fiction: Write a Short tory from Personal Experience</p>
                                  <span className="total-duration">01 hour 48 minutes</span>
                              </button>

                              <div id="collapseSaven" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <!-- Accordion Items Start  --> */}
                          <div className="accordion-item">
                              <button className="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight">
                                  <p>Lesson-08: Writing for Self-Discovery: 6 Journaling Prompts for Gratitude and Growth</p>
                                  <span className="total-duration">01 hour 48 minutes</span>
                              </button>

                              <div id="collapseEight" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <!-- Accordion Items Start  --> */}
                          <div className="accordion-item">
                              <button className="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine">
                                  <p>Lesson-09: Copywriting For Beginners: How To Write Web Copy That Sells Without Being Cheesy</p>
                                  <span className="total-duration">01 hour 48 minutes</span>
                              </button>

                              <div id="collapseNine" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
                          ...
                          <!-- Accordion Items Start  --> */}
                          <div className="accordion-item">
                              <button className="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen">
                                  <p>Lesson-10: How to Write a Personal Statement - The Complete Medicine MasterclassName</p>
                                  <span className="total-duration">01 hour 48 minutes</span>
                              </button>

                              <div id="collapseTen" className="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                  <nav className="vids">
                                      <a className="link" href="https://player.vimeo.com/external/215175080.hd.mp4?s=5b17787857fd95646e67ad0f666ea69388cb703c&amp;profile_id=119">
