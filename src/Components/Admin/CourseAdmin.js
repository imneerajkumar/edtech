        ...
        <div className="section overflow-hidden position-relative" id="wrapper">
            ...
            <div className="sidebar-wrapper" style={{backgroundColor: "#309255"}}>
                <div className="menu-list">
                    <Link to="/admin" className='active'><img src="assets/images/menu-icon/icon-5.png" alt="Icon" /></Link>
                ...
                <div className="container-fluid custom-container">
                    ...
                    <div className="admin-courses-tab">
                        ...
                        <div className="courses-tab-wrapper">
                            ...
                            <ul className="nav">
                                <li><button className="active" data-bs-toggle="tab" data-bs-target="#tab1">1</button></li>
                                <li><button data-bs-toggle="tab" data-bs-target="#tab2">2</button></li>
                            ...
                            <div className="tab-pane fade show active" id="tab1">
                                ...
                                <div className="courses-item">
                                    ...
                                    <div className="content-title">
                                        ...
                                        <h3 className="title"><a href="/course-details">Build An eCommerce Site With WooCommerce and WooLentor.</a></h3>
                                    </div>
