...
function Students(props) {
    ...
    const [responsive,setResponsive]=useState(window.screen.availWidth)
					...
					<div className="main-content-wrapper">
                      ...
                      <!-- Student's Wrapper Start --> */}
							<div className="students-wrapper students-active">
								<div className="swiper-container">
									<Swiper
										slidesPerView={responsive < 768 ? 1 : 2}
										spaceBetween={10}
										effect={"fade"}
										pagination={{
											clickable: true,
											...
											>
												...
												<div className="student-content">
													...
													<span className="country">
														<img
															src="assets/images/flag/flag-1.png"
															alt="Flog"
														/>{" "}
														Brazil
													</span>
                      ...
                      <!-- Student's Widget Start --> */}
											...
											<div className="widget-items">
												...
												<div className="single-item">
													<div className="item-flag">
														<div className="flag">
															<img
																src="assets/images/flag/flag-2.png"
																alt="Flag"
															/>
														</div>
                                          ...
                                          <!-- Single Item Start --> */}
												<div className="single-item">
													<div className="item-flag">
														<div className="flag">
															<img
																src="assets/images/flag/flag-3.png"
																alt="Flag"
															/>
														</div>
                                          ...
                                          <!-- Single Item Start --> */}
												<div className="single-item">
													<div className="item-flag">
														<div className="flag">
															<img
																src="assets/images/flag/flag-4.png"
																alt="Flag"
															/>
														</div>
                                          ...
                                          <!-- Single Item Start --> */}
												<div className="single-item">
													<div className="item-flag">
														<div className="flag">
															<img
																src="assets/images/flag/flag-5.png"
																alt="Flag"
															/>
														</div>
												...
												<div className="single-item">
													<div className="item-flag">
														<div className="flag">
															<img
																src="assets/images/flag/flag-6.png"
																alt="Flag"
															/>
														</div>
							...
							<div
								...
								style={{
									backgroundImage: "url(assets/images/new-courses-banner.jpg)",
								}}
							>
								<div className="new-courses-title">
									<h3 className="title">
										Your students want to learn more. <br /> Consider creating
										new courses to meet that deman.
									</h3>
								</div>
