...
function About(props) {
	...
	const [data, setData] = useState([
		{
			name: "Student 1",
			feedback:
				"Lorem Ipsum has been the industry's standard dummy text since the 1500 when unknown printer took a galley type and scrambled to make type specimen’s book has survived not five centuries but also the leap into electronic type and book.",
		},
		{
			name: "Person 1",
			feedback:
	...
	const feed = [
		{
			imgUrl: "assets/images/author/author-01.jpg",
			name: "Margarita James",
			rating: 4.9,
			designation: "MSC, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-02.jpg",
			name: "Mitchell Colon",
			rating: 4.9,
			designation: "BBA, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-03.jpg",
			name: "Sonya Gordon",
			rating: 4.9,
			designation: "MBA, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-04.jpg",
			name: "Archie Neal",
			rating: 4.9,
			designation: "BBS, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-05.jpg",
			name: "Randal Ramsey",
			rating: 4.9,
			designation: "MBBS, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-06.jpg",
			name: "Rochelle Thomas",
			rating: 4.9,
			designation: "MSC, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-07.jpg",
			name: "Della Salazar",
			rating: 4.9,
			designation: "BBA, Instructor",
		},
		...
		{
			imgUrl: "assets/images/author/author-08.jpg",
			name: "Ricardo Patrick",
			rating: 4.9,
			designation: "MBA, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-09.jpg",
			name: "Kurt Stewart",
			rating: 4.9,
			designation: "BBS, Instructor",
		},
		{
			imgUrl: "assets/images/author/author-10.jpg",
			name: "Rodney Terry",
			rating: 4.9,
			designation: "MBBS, Instructor",
		},
						...
						<div className="row">
							...
							<div className="col-lg-6">
								...
								<div className="about-content">
									...
									<a href="/courses" className="btn btn-primary btn-hover-dark">
										Start A Course
									</a>
								</div>
								{/* <!-- About Content End --> */}
